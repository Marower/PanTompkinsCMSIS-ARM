...
/************************************************************
    Timing constants (assumption Sampling Frequency = 360 Hz)
 ************************************************************/
#define PT150MS				((int16_t)	(54))
#define PT200MS				((int16_t)	(72))
#define PT360MS				((int16_t)	(130))
#define PT1000MS			((int16_t)	(360))
#define PT2000MS			((int16_t)	(720))
#define PT4000MS			((int16_t)	(144))
#define GENERAL_DELAY		((int16_t)	(50))

/*************************************************************
	RR Limits constants for startup (92,116, 166 % OF 200)
*************************************************************/
#define RR92PERCENT			((int16_t)	(332))
#define RR116PERCENT		((int16_t)	(418))
#define RR166PERCENT		((int16_t)	(600))
/************************************************************
    General constants
 ************************************************************/
...
#define MVA_BUFFER_SIZE              ((int16_t)  (54))
